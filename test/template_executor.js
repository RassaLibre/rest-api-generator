...
describe('Template_Executor', function(){
  ...
  it('should execute normal templates', function(){
    ...
    assert(typeof normal_templates[0]['executed_template'], "string");
    assert(normal_templates[0]['executed_template'], "something even more silly");
  });
  ...
  it('should execute duplicated templates', function(){
    ...
    assert(Object.keys(duplicated_templates[0]['executed_templates']).length, 4);
    assert(duplicated_templates[0]['executed_templates']['Oven'],"something silly");
  });
